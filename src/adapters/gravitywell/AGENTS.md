...
- Preserve the one-pixel projected overlap beyond both ends of every prepared
  two-pixel line quad. It covers shared endpoints after independent compositor
  quantization without changing topology or adding runtime work.

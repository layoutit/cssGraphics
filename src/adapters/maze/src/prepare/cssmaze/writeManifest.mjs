...
export async function writeCssmazePreparedOutput({ scenes, defaultSceneId = "default-maze", preparedBank } = {}) {
  ...
  const manifest = Object.freeze({
    ...
    runtime: Object.freeze({
      ...
      routeContract: "/ advances through a session-persistent shuffled prepared bank; ?scene=<manifest-scene-id> pins one prepared scene",
      startupSelection: "session-persistent-crypto-shuffled-prepared-bank",
      sceneChangeControl: false,
      automaticPreparedSceneChange: true,
      immediateSceneRepeat: false,
      repeatBeforeFullBankCycle: false,

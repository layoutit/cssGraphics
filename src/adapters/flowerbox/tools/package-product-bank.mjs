...
try {
  ...
  await writeFlowerboxProductBankDescriptor(stagingRoot, summary, {
    ...
    productPolicy: "rounded-360-state-positive-petals-omitted-negative-cube-retained-polycss-morph-q83-side-boundary-half-plane-alpha-boundary-0.125-minimum-8-owned-pixels",
    sanitization: [

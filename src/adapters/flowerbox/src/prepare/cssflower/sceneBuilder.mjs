...
export async function buildCssflowerFirstSliceScene({
  ...
  const scene = Object.freeze({
    ...
    playback: Object.freeze({
      ...
      scope: "rounded-product-cycle-positive-petals-omitted-negative-cube-lobe-retained",
      ...
      cycle: Object.freeze({
        ...
        bloomMinimumGeometryStateIndex: compiled.cycle.bloomMinimumGeometryStateIndex,
        bloomMinimumSf: compiled.cycle.bloomMinimumSf,
        bloomMinimumSfHex: compiled.cycle.bloomMinimumSfHex,
        bloomMinimumSfNominal: compiled.cycle.bloomMinimumSfNominal,
        bloomSourcePathLength: compiled.cycle.bloomSourcePathLength,
        bloomPacing: compiled.cycle.bloomPacing,
    ...
    warnings: Object.freeze([
      ...
      "The product deliberately omits the positive source petal states at nominal sf >= 2.5, retains the source-derived negative cube lobe through sf = -1.1499998569488525, and uses a prepared 180-state rounded bloom twice inside one 360-state rotation. The independent 9,331-tick source/native oracle remains complete; current native/browser visual comparison remains limited to the retained tick-0-to-45 prefix.",
      ...
      "Runtime lighting selection uses an exact prepared RGB8, canonical alpha-edge-mask, and conjoined-state side-boundary clip geometry per-triangle change schedule. Positive lobe states beyond sf 0x3f800001 retain sibling-edge coverage across face junctions; the lossy AVIF grid can still produce small location-dependent raster differences when an equivalent prepared field is addressed from a different state.",

...
- The source directional light and retained orientation produce prepared per-root brightness. Fixed per-face factors replace smooth per-vertex interpolation and specular response.
